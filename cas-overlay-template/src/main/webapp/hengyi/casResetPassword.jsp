...
<%
    ...
    if (employeeid != null & adminpassword != null & newpassword != null & username != null) {
        if (employeeid.equals("")) {
            response.sendRedirect("./casNull.jsp");
            return;
        }
        if (!employeeid.equals("") & !adminpassword.equals("") & !newpassword.equals("") & !username.equals("")) {
            ...
            try {
                ...
                String command = "resetpassword " + employeeid + " " + adminpassword + " " + username + " " + newpassword;
                pwr.print(command + "\n\r");
                pwr.flush();
                result = read.readLine();
                read.close();
            ...
            String msg = " <script language=javascript> alert('reset password failure');</script> ";
            if (result.equals("0")) {

                msg = "<script language=javascript>alert('reset password succeed')</script> ";
            }
            out.println(msg);
        }
    }
...
<head>
    ...
    <title>用户密码重置</title>
<body>
<form name="resetpwd" action="./casResetPassword.jsp" method="post">
    ...
    重置密码: <input name="newpassword" type="password" value=""><br>
