    ...
    if (employeeid != null & adminpassword != null & newpassword != null & username != null & username2 != null) {
        ...
        if (!employeeid.equals("") & !adminpassword.equals("") & !newpassword.equals("") & !username.equals("") & !username2.equals("")) {
            ...
            try {
                ...
                String command = "createinfouser " + employeeid + " " + adminpassword + " " + username + " " + username2 + " " + newpassword;
                pwr.print(command + "\n\r");
                pwr.flush();
                result = read.readLine();
                read.close();
            ...
            String msg = " <script language=javascript> alert('create infouser failure');</script> ";
            if (result.equals("0")) {
